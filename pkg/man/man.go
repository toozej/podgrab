// Package man provides manual page generation functionality for the podgrab application.
//
// This package creates Unix manual pages (man pages) for the podgrab CLI
...
// for the podgrab application. The command traverses the root command tree
...
func NewManCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:                   "man",
		Short:                 "Generates podgrab's command line manpages",
		SilenceUsage:          true,
